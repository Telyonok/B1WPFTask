...
{
    internal class RandomRowRepository<T> : IRepository<T> where T : class, IEntity
    {
        private readonly RandomRowDBContext _context;

        public RandomRowRepository(RandomRowDBContext context) => _context = context;
